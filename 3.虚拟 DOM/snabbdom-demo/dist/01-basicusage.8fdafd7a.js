...
var app = document.querySelector('#app'); // 第一个参数：旧的 VNode，可以是真实 DOM，此时会将真实 DOM 渲染为 VNode
// 第二个参数：新的 VNode
// 返回新的 VNode

var oldVnode = patch(app, vnode); // 更新 DOM

vnode = (0, _h.h)('div#container.xc', 'Hello Snabbdom');
